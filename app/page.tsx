...
const principles = [
  [
    "Everybody belongs.",
    "Different bodies, backgrounds, ages, paces and levels of experience are welcome.",
  ],
  [
    "We communicate.",
    "We speak clearly, listen and make sure nobody is left guessing.",
  ],
  ["We look out for each other.", "We wait, help and arrive together."],
  [
    "We ride with respect for nature.",
    "We choose responsible routes, materials and decisions.",
  ],
  [
    "We build community, not ego.",
    "People matter more than status, equipment or performance.",
  ],
  [
    "We keep improving. Always.",
    "We stay open, learn and hold ourselves accountable.",
  ],
];
...
export default function Home() {
      ...
      <main id="top">
        <section className="hero">
          ...
          <div className="heroCopy">
            ...
            <a className="buttonLight" href="#manifesto">
              This is BE:LON →
            </a>
          </div>

          <a className="scrollHint" href="#manifesto">
            Scroll down ↓
          </a>
        </section>
        ...
        <section id="manifesto" className="manifesto">
          <div className="manifestoCopy">
            ...
            <p>
              We create clothing not to show who belongs, but as a sign that
              everyone can belong. Maybe you buy a jersey. Maybe you do not.
              What matters is that you ride again tomorrow — and bring someone
              with you.
            </p>
          ...
          <div className="manifestoVisual">
            <Image
              ...
              alt="Two penguins standing together before a mountain landscape"
              fill
              sizes="65vw"
              className="cover"
            />
        ...
        <section id="constitution" className="constitution">
          <div className="constitutionIntro">
            ...
            <p>
              The BE:LON Constitution is our foundation. It defines how we ride,
              how we make decisions and how we treat people and the planet.
            </p>

            <Link
              className="textLink lightLink"
              href="/constitution"
            >
        ...
        <section id="collective" className="collective">
          <div className="collectiveCopy">
            ...
            <p>
              We are a global community of riders who support each other on and
              off the bike. Join the ride.
            </p>
          ...
          <div className="collectiveImage">
            <Image
              ...
              alt="Two cyclists hugging after a ride"
              fill
              sizes="70vw"
              className="cover"
            />
        ...
        <section className="impactRides">
          <article className="textTile">
            ...
            <p>
              Add €5 to your order or donate any amount. One hundred percent
              goes into the BE:LON Fund to support initiatives that make cycling
              more accessible.
            </p>

            <Link className="textLink" href="/ride-it-forward">
              See the impact →
            </Link>
          </article>
          ...
          <div className="imagePanel">
            <Image
              src="/forward.jpg.png"
              alt="A cyclist looking over a mountain landscape at sunset"
              fill
              sizes="20vw"
              className="cover"
            />
  ...
  Read the Journal →
          ...
          <div className="imagePanel">
            <Image
              src="/rides.jpg.png"
              alt="A group of cyclists riding along a mountain road"
              fill
              sizes="35vw"
              className="cover"
            />
